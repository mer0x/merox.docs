...
> Complete script content available on Github: [k3s-deploy](https://github.com/mer0x/merox.cloud/blob/k3s/K3S/cluster-deployment/k3s.sh)
{.is-danger}
...
### install_rancher_and_certmanager.bash
```bash
